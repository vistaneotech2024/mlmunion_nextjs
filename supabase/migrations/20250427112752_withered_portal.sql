/*
  # Add admin_get_stats function

  1. New Function
    - Create admin_get_stats function to get dashboard statistics
    - Returns counts for users, companies, blogs, classifieds, and sellers
    - Includes status breakdowns for each category
...
-- Create admin_get_stats function
