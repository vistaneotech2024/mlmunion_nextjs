...
export function NewsCategoryManagement() {
  ...
  const [editingCategory, setEditingCategory] = React.useState<NewsCategory | null>(null);
  ...
  const toggleActive = async (category: NewsCategory) => {
    try {
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-3 md:gap-0">
        <h3 className="text-xl md:text-xl font-semibold text-gray-900">News Categories</h3>
        <button
          onClick={() => {
            setEditingCategory(null);
            setShowModal(true);
